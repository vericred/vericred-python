...
from vericred_client.models.network_details_response import NetworkDetailsResponse


class TestNetworkDetailsResponse(unittest.TestCase):
    """ NetworkDetailsResponse unit test stubs """
    ...
    def testNetworkDetailsResponse(self):
        """
        Test NetworkDetailsResponse
        """
        model = vericred_client.models.network_details_response.NetworkDetailsResponse()
