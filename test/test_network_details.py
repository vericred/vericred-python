...
from vericred_client.models.network_details import NetworkDetails


class TestNetworkDetails(unittest.TestCase):
    """ NetworkDetails unit test stubs """
    ...
    def testNetworkDetails(self):
        """
        Test NetworkDetails
        """
        model = vericred_client.models.network_details.NetworkDetails()
