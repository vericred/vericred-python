...
from vericred_client.models.vendored_plan_bulk import VendoredPlanBulk


class TestVendoredPlanBulk(unittest.TestCase):
    """ VendoredPlanBulk unit test stubs """
    ...
    def testVendoredPlanBulk(self):
        """
        Test VendoredPlanBulk
        """
        model = vericred_client.models.vendored_plan_bulk.VendoredPlanBulk()
