...
from vericred_client.apis.drug_packages_api import DrugPackagesApi


class TestDrugPackagesApi(unittest.TestCase):
    """ DrugPackagesApi unit test stubs """

    def setUp(self):
        self.api = vericred_client.apis.drug_packages_api.DrugPackagesApi()

    def tearDown(self):
        pass

    def test_show_formulary_drug_package_coverage(self):
        """
        Test case for show_formulary_drug_package_coverage
