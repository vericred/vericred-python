...
from vericred_client.models.provider_geocode import ProviderGeocode


class TestProviderGeocode(unittest.TestCase):
    """ ProviderGeocode unit test stubs """
    ...
    def testProviderGeocode(self):
        """
        Test ProviderGeocode
        """
        model = vericred_client.models.provider_geocode.ProviderGeocode()
