...
from vericred_client.models.plan_search_response_meta import PlanSearchResponseMeta


class TestPlanSearchResponseMeta(unittest.TestCase):
    """ PlanSearchResponseMeta unit test stubs """
    ...
    def testPlanSearchResponseMeta(self):
        """
        Test PlanSearchResponseMeta
        """
        model = vericred_client.models.plan_search_response_meta.PlanSearchResponseMeta()
