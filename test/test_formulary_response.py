...
from vericred_client.models.formulary_response import FormularyResponse


class TestFormularyResponse(unittest.TestCase):
    """ FormularyResponse unit test stubs """
    ...
    def testFormularyResponse(self):
        """
        Test FormularyResponse
        """
        model = vericred_client.models.formulary_response.FormularyResponse()
