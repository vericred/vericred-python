...
class Provider(object):
    ...
    """
    def __init__(self, city=None, email=None, gender=None, first_name=None, id=None, last_name=None, latitude=None, longitude=None, middle_name=None, network_ids=None, organization_name=None, phone=None, presentation_name=None, specialty=None, state=None, state_id=None, street_line_1=None, street_line_2=None, suffix=None, title=None, type=None, zip_code=None, npis=None):
        """
    ...
    def npis(self, npis):
        """
        Sets the npis of this Provider.
        The National Provider Index (NPI) numbers associated with this provider.

        :param npis: The npis of this Provider.
        :type: list[int]
        """
