...
class RequestPlanFind(object):
    ...
    """
    def __init__(self, applicants=None, enrollment_date=None, drug_packages=None, fips_code=None, household_income=None, household_size=None, market=None, providers=None, page=None, per_page=None, sort=None, zip_code=None):
        """
