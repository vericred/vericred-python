...
class RequestProvidersSearch(object):
    ...
    """
    def __init__(self, accepts_insurance=None, ids=None, min_score=None, network_ids=None, page=None, per_page=None, polygon=None, radius=None, search_term=None, sort=None, sort_seed=None, type=None, zip_code=None):
        """
    ...
    def ids(self):
        """
        Gets the ids of this RequestProvidersSearch.
        List of NPIs

        :return: The ids of this RequestProvidersSearch.
        :rtype: list[int]
        """
        return self._ids
    ...
    def ids(self, ids):
        """
        Sets the ids of this RequestProvidersSearch.
        List of NPIs

        :param ids: The ids of this RequestProvidersSearch.
        :type: list[int]
        """
