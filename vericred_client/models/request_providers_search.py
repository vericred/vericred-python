...
class RequestProvidersSearch(object):
    ...
    """
    def __init__(self, accepts_insurance=None, hios_ids=None, min_score=None, network_ids=None, page=None, per_page=None, radius=None, search_term=None, zip_code=None, type=None):
        """
