# vericred_client.MedicalPlansApi
...
api_instance = vericred_client.MedicalPlansApi()
...
try: 
    ...
    print("Exception when calling MedicalPlansApi->find_plans: %s\n" % e)
```
...
year = 2018 # int | Plan year (defaults to current year) (optional)
...
try: 
    ...
    print("Exception when calling MedicalPlansApi->show_plan: %s\n" % e)
```
